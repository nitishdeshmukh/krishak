...
import { createBulkAttendance, fetchAttendanceByDate, fetchAttendanceReport, deleteAttendance } from '../api/attendanceApi';
...
export const useAttendance = () => {
    ...
    return {
        ...
        hasNext: (query.data?.pagination?.currentPage || 1) < (query.data?.pagination?.totalPages || 0),
