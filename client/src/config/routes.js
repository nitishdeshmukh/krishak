...
const StockReport = lazy(() => import("@/pages/Core/StockReport"));
const DailyReport = lazy(() => import("@/pages/Core/DailyReport"));
const BrokerTransactionReport = lazy(() =>
  import("@/pages/Core/BrokerTransactionReport")
);
const PartyTransactionReport = lazy(() =>
  import("@/pages/Core/PartyTransactionReport")
);
const AddParty = lazy(() => import("@/pages/Entry/AddParty"));
const PartyEntryReport = lazy(() =>
  import("@/pages/EntryReports/PartyEntryReport")
);
const TransportersEntryReport = lazy(() =>
  import("@/pages/EntryReports/TransportersEntryReport")
);
const BrokerEntryReport = lazy(() =>
  import("@/pages/EntryReports/BrokerEntryReport")
);
const CommitteeEntryReport = lazy(() =>
  import("@/pages/EntryReports/CommitteeEntryReport")
);
const DOEntryReport = lazy(() => import("@/pages/EntryReports/DOEntryReport"));
const VehicleEntryReport = lazy(() =>
  import("@/pages/EntryReports/VehicleEntryReport")
);
const StaffEntryReport = lazy(() =>
  import("@/pages/EntryReports/StaffEntryReport")
);
const LaborTeamEntryReport = lazy(() =>
  import("@/pages/EntryReports/LaborTeamEntryReport")
);
const RemainingDOInfo = lazy(() =>
  import("@/pages/EntryReports/RemainingDOInfo")
);
const PaddyPurchaseDealReport = lazy(() =>
  import("@/pages/Deal/PaddyPurchaseDealReport")
);
const RicePurchaseDealReport = lazy(() =>
  import("@/pages/Deal/RicePurchaseDealReport")
);
const PaddyDoSalesDealReport = lazy(() =>
  import("@/pages/Deal/PaddyDoSalesDealReport")
);
const PaddyMillSalesDealReport = lazy(() =>
  import("@/pages/Deal/PaddyMillSalesDealReport")
);
const PaddyInwardReport = lazy(() =>
  import("@/pages/Inward/PaddyInwardReport")
);
const PrivateInwardReport = lazy(() =>
  import("@/pages/Inward/PrivateInwardReport")
);
...
const AddPaddyPurchase = lazy(() =>
  import("@/pages/Purchase/AddPaddyPurchase")
);
...
const AddOtherPurchase = lazy(() =>
  import("@/pages/Purchase/AddOtherPurchase")
);
...
const AddGovPaddyInward = lazy(() =>
  import("@/pages/Inward/AddGovPaddyInward")
);
const AddPrivatePaddyInward = lazy(() =>
  import("@/pages/Inward/AddPrivatePaddyInward")
);
...
const AddPrivatePaddyOutward = lazy(() =>
  import("@/pages/Outward/AddPrivatePaddyOutward")
);
const AddGovtRiceOutward = lazy(() =>
  import("@/pages/Outward/AddGovtRiceOutward")
);
const AddPrivateRiceOutward = lazy(() =>
  import("@/pages/Outward/AddPrivateRiceOutward")
);
const AddGovtSackOutward = lazy(() =>
  import("@/pages/Outward/AddGovtSackOutward")
);
const AddPrivateSackOutward = lazy(() =>
  import("@/pages/Outward/AddPrivateSackOutward")
);
const AddFrkOutward = lazy(() => import("@/pages/Outward/AddFrkOutward"));
const AddBrokensOutward = lazy(() =>
  import("@/pages/Outward/AddBrokensOutward")
);
const AddBrewersOutward = lazy(() =>
  import("@/pages/Outward/AddBrewersOutward")
);
const AddHuskOutward = lazy(() => import("@/pages/Outward/AddHuskOutward"));
const AddRiceBranOutward = lazy(() =>
  import("@/pages/Outward/AddRiceBranOutward")
);
const AddWhiteBranOutward = lazy(() =>
  import("@/pages/Outward/AddWhiteBranOutward")
);
...
const AddOutwardLaborEntry = lazy(() =>
  import("@/pages/LaborCost/AddOutwardLaborEntry")
);
const OutwardLaborReport = lazy(() =>
  import("@/pages/LaborCost/OutwardLaborReport")
);
const AddInwardLaborEntry = lazy(() =>
  import("@/pages/LaborCost/AddInwardLaborEntry")
);
const AddMillingLaborEntry = lazy(() =>
  import("@/pages/LaborCost/AddMillingLaborEntry")
);
const AddOtherLaborEntry = lazy(() =>
  import("@/pages/LaborCost/AddOtherLaborEntry")
);
const InwardLaborReport = lazy(() =>
  import("@/pages/LaborCost/InwardLaborReport")
);
const MillingLaborReport = lazy(() =>
  import("@/pages/LaborCost/MillingLaborReport")
);
const OtherLaborReport = lazy(() =>
  import("@/pages/LaborCost/OtherLaborReport")
);
const OtherPurchaseDealReport = lazy(() =>
  import("@/pages/Deal/OtherPurchaseDealReport")
);
const OtherSalesDealReport = lazy(() =>
  import("@/pages/Deal/OtherSalesDealReport")
);
const OtherInwardReport = lazy(() =>
  import("@/pages/Inward/OtherInwardReport")
);
const OtherOutwardReport = lazy(() =>
  import("@/pages/Outward/OtherOutwardReport")
);
const SackPurchaseDealReport = lazy(() =>
  import("@/pages/Deal/SackPurchaseDealReport")
);
const FRKPurchaseDealReport = lazy(() =>
  import("@/pages/Deal/FRKPurchaseDealReport")
);
const RiceSalesDealReport = lazy(() =>
  import("@/pages/Deal/RiceSalesDealReport")
);
const SackSalesDealReport = lazy(() =>
  import("@/pages/Deal/SackSalesDealReport")
);
const FRKSalesDealReport = lazy(() =>
  import("@/pages/Deal/FRKSalesDealReport")
);
const BrokensSalesDealReport = lazy(() =>
  import("@/pages/Deal/BrokensSalesDealReport")
);
const BrewersSalesDealReport = lazy(() =>
  import("@/pages/Deal/BrewersSalesDealReport")
);
const HuskSalesDealReport = lazy(() =>
  import("@/pages/Deal/HuskSalesDealReport")
);
const RiceBranSalesDealReport = lazy(() =>
  import("@/pages/Deal/RiceBranSalesDealReport")
);
const WhiteBranSalesDealReport = lazy(() =>
  import("@/pages/Deal/WhiteBranSalesDealReport")
);
...
const PrivatePaddyOutwardReport = lazy(() =>
  import("@/pages/Outward/PrivatePaddyOutwardReport")
);
const GovtRiceOutwardReport = lazy(() =>
  import("@/pages/Outward/GovtRiceOutwardReport")
);
const PrivateRiceOutwardReport = lazy(() =>
  import("@/pages/Outward/PrivateRiceOutwardReport")
);
const GovtSackOutwardReport = lazy(() =>
  import("@/pages/Outward/GovtSackOutwardReport")
);
const PrivateSackOutwardReport = lazy(() =>
  import("@/pages/Outward/PrivateSackOutwardReport")
);
const FrkOutwardReport = lazy(() => import("@/pages/Outward/FrkOutwardReport"));
const BrokensOutwardReport = lazy(() =>
  import("@/pages/Outward/BrokensOutwardReport")
);
const BrewersOutwardReport = lazy(() =>
  import("@/pages/Outward/BrewersOutwardReport")
);
const HuskOutwardReport = lazy(() =>
  import("@/pages/Outward/HuskOutwardReport")
);
const RiceBranOutwardReport = lazy(() =>
  import("@/pages/Outward/RiceBranOutwardReport")
);
const WhiteBranOutwardReport = lazy(() =>
  import("@/pages/Outward/WhiteBranOutwardReport")
);
const PaddyMillingReport = lazy(() =>
  import("@/pages/Milling/PaddyMillingReport")
);
const RiceMillingReport = lazy(() =>
  import("@/pages/Milling/RiceMillingReport")
);
const AddAttendanceEntry = lazy(() =>
  import("@/pages/Attendance/AddAttendanceEntry")
);
...
const AddReceivingEntry = lazy(() =>
  import("@/pages/Financial/AddReceivingEntry")
);
...
export const routes = [
  ...
  {
    path: "/reports/broker/transaction",
    component: BrokerTransactionReport,
    title: "Broker Transaction",
    titleKey: "reports:brokerTransaction.title",
    icon: DocumentTextIcon,
    showInSidebar: true,
    view: "reports",
  },
  {
    path: "/reports/party/transaction",
    component: PartyTransactionReport,
    title: "Party Transaction",
    titleKey: "reports:partyTransaction.title",
    icon: DocumentTextIcon,
    showInSidebar: true,
    view: "reports",
  },
  ...
  },
  {
    ...
    children: [
      {
        path: "/reports/sales/paddy-do",
        component: PaddyDoSalesDealReport,
        title: "Paddy DO Sales Report",
        titleKey: "reports:sections.sales.paddyDo",
        showInSidebar: true,
      },
      {
        path: "/reports/sales/paddy-mill",
        component: PaddyMillSalesDealReport,
        title: "Paddy Mill Sales Report",
        titleKey: "reports:sections.sales.paddyMill",
        showInSidebar: true,
      },
      {
