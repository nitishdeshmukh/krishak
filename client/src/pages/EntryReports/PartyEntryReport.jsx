...
export default function PartyEntryReport() {
  ...
  const { parties, totalPages, currentPage, isLoading, isError, error } =
    useParties();
    ...
    <div className="container mx-auto py-2">
      <Card className={"py-0"}>
        <CardContent className="p-6">
          <DataTable columns={columns} data={parties} showFilters={false} />
                ...
                <div className="flex-1 rounded-xl border border-border/50 bg-muted/20 px-4 py-3 text-center">
                  ...
                  <p className="text-xs font-medium text-foreground">
                    {selectedParty.createdAt
                      ? new Date(selectedParty.createdAt).toLocaleDateString(
                          "en-IN",
                ...
                <div className="flex-1 rounded-xl border border-border/50 bg-muted/20 px-4 py-3 text-center">
                  ...
                  <p className="text-xs font-medium text-foreground">
                    {selectedParty.updatedAt
                      ? new Date(selectedParty.updatedAt).toLocaleDateString(
                          "en-IN",
                          { day: "numeric", month: "short", year: "numeric" }
                        )
                      : "—"}
