...
export default function BrokerTransactionReport() {
  ...
  const handleDateChange = (data) => {
    ...
    // Fetch broker transaction data for the selected date range
  };
  ...
  const headerGroups = [
    {
      headers: [
        ...
        { label: "पार्टी का नाम", rowSpan: 2, className: "min-w-[120px]" },
  ...
  // Define columns
  const columns = [
    { accessor: "brokerName", cellClassName: "sticky left-0 z-10 bg-card" },
    { accessor: "partyName" },
  ...
  const emptyState = (
    <div className="flex flex-col items-center gap-2">
      ...
      <p className="text-sm">चयनित अवधि के लिए कोई ब्रोकर लेनदेन नहीं मिला</p>
    </div>
  );
  ...
  return (
    <div className="container mx-auto py-4 px-4">
      ...
      <div className="mb-6 flex items-start justify-between gap-4 flex-wrap">
        <div>
          <h1 className="text-2xl font-bold text-foreground flex items-center gap-3">
            ...
            ब्रोकर लेनदेन (Broker Transaction)
          </h1>
          <p className="text-sm text-muted-foreground mt-1">
            ब्रोकर-वार लेनदेन विवरण
          </p>
        </div>
      ...
      {/* Broker Transaction Table using ReportTableSection */}
      <ReportTableSection title="ब्रोकर लेनदेन विवरण" theme="indigo">
        <ReportTable
