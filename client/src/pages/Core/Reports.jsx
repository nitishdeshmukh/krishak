  ...
  const salesReportCards = [
    {
      ...
      title: t("reports:sections.sales.paddyDo") || "Paddy DO Sales",
      onClick: () => navigate("/reports/sales/paddy-do"),
      iconBg: "bg-emerald-100",
      iconColor: "text-emerald-600",
    },
    {
      icon: CurrencyDollarIcon,
      title: t("reports:sections.sales.paddyMill") || "Paddy Mill Sales",
      onClick: () => navigate("/reports/sales/paddy-mill"),
      iconBg: "bg-emerald-100",
      iconColor: "text-emerald-600",
    },
    {
    ...
    <div className="space-y-8">
      ...
      <section>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-2xl font-bold">
            {t("reports:sections.entry.title")}
          </h2>
        </div>
      ...
      <section>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-2xl font-bold">
            {t("reports:sections.purchase.title")}
          </h2>
        </div>
      ...
      <section>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-2xl font-bold">
            {t("reports:sections.sales.title")}
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <section>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-2xl font-bold">
            {t("reports:sections.inward.title")}
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <section>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-2xl font-bold">
            {t("reports:sections.outward.title") || "Outward Reports"}
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <section>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-2xl font-bold">
            {t("reports:sections.milling.title") || "Milling Reports"}
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <section>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-2xl font-bold">
            {t("reports:sections.laborCost.title") || "Labor Cost Reports"}
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            {
              icon: UserGroupIcon,
              title:
                t("reports:sections.laborCost.inward") ||
                "Inward Labor (जावक हमाली)",
            ...
            },
            {
              icon: UserGroupIcon,
              title:
                t("reports:sections.laborCost.outward") ||
                "Outward Labor (जावक हमाली)",
            ...
            },
            {
              icon: UserGroupIcon,
              title:
                t("reports:sections.laborCost.milling") ||
                "Milling Labor (मिलिंग हमाली)",
            ...
            },
            {
              icon: UserGroupIcon,
              title:
                t("reports:sections.laborCost.other") ||
                "Other Labor (अन्य हमाली)",
      ...
      <section>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-2xl font-bold">
            {t("reports:sections.attendance.title") || "Attendance Reports"}
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            {
              icon: UserGroupIcon,
              title:
                t("reports:sections.attendance.title") ||
      ...
      <section>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-2xl font-bold">
            {t("reports:sections.financial.title") || "Financial Reports"}
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            {
              icon: BanknotesIcon,
              title:
                t("reports:sections.financial.receiving") ||
                "Receiving Report (रसीद रिपोर्ट)",
            ...
            },
            {
              icon: BanknotesIcon,
              title:
                t("reports:sections.financial.payment") ||
