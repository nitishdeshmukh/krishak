...
const schema = new mongoose.Schema({
    ...
    paddySaleNumber: { type: String, trim: true },
    ...
    saleQuantity: { type: String, trim: true },
...
// Auto-generate outwardNumber: PPO-DDMMYY-N
schema.pre('save', createNumberGeneratorMiddleware('outwardNumber', 'PPO'));

schema.plugin(aggregatePaginate);
export default mongoose.model('PrivatePaddyOutward', schema);
