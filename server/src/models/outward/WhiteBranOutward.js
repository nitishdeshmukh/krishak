...
const schema = new mongoose.Schema({
    ...
    silkyKodhaSaleNumber: { type: String, trim: true },
...
// Auto-generate outwardNumber: WBO-DDMMYY-N
schema.pre('save', createNumberGeneratorMiddleware('outwardNumber', 'WBO'));

schema.plugin(aggregatePaginate);
export default mongoose.model('WhiteBranOutward', schema);
