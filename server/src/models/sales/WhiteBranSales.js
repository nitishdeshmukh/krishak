...
const schema = new mongoose.Schema({
    ...
    silkyKodhaQuantity: { type: String, trim: true },
    silkyKodhaRate: { type: String, trim: true },
    silkyKodhaAmount: { type: String, trim: true },
...
// Auto-generate dealNumber: WBS-DDMMYY-N (White Bran Sales)
schema.pre('save', createNumberGeneratorMiddleware('dealNumber', 'WBS'));

schema.plugin(aggregatePaginate);
export default mongoose.model('WhiteBranSales', schema);
