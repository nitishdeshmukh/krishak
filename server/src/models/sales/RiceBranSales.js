...
const schema = new mongoose.Schema({
    ...
    kodhaQuantity: { type: String, trim: true },
    kodhaRate: { type: String, trim: true },
    kodhaAmount: { type: String, trim: true },
...
// Auto-generate dealNumber: RBS-DDMMYY-N (Rice Bran Sales)
schema.pre('save', createNumberGeneratorMiddleware('dealNumber', 'RBS'));

schema.plugin(aggregatePaginate);
export default mongoose.model('RiceBranSales', schema);
