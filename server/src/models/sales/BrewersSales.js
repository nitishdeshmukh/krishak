...
const schema = new mongoose.Schema({
    ...
    nakkhiQuantity: { type: String, trim: true },
    nakkhiRate: { type: String, trim: true },
    nakkhiAmount: { type: String, trim: true },
...
// Auto-generate dealNumber: BS-DDMMYY-N (Brewers Sales)
schema.pre('save', createNumberGeneratorMiddleware('dealNumber', 'BS'));

schema.plugin(aggregatePaginate);
export default mongoose.model('BrewersSales', schema);
