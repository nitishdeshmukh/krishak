...
export const getCommittees = asyncHandler(async (req, res) => {
    ...
    const result = await Committee.aggregatePaginate(aggregate, { page, limit: pageSize });
...
export const createCommittee = asyncHandler(async (req, res) => {
    ...
    res.status(201).json({ success: true, message: 'Committee created successfully', data: committee });
});
...
export const updateCommittee = asyncHandler(async (req, res) => {
    ...
    res.status(200).json({ success: true, message: 'Committee updated successfully', data: committee });
});
